...
import apps.ubuzima.views as views
...
urlpatterns = patterns('',
    ...
    url(r'^ubuzima/alerts/type/(?P<pk>\d+)$', views.alerts_by_type),
    ...
    url(r'^ubuzima/nutrition$', views.nutrition),
    url(r'^ubuzima/nutrition/(?P<indic>\d+)/(?P<format>html|csv)$', views.view_nutrition),
    url(r'^ubuzima/newborn$', views.newborn),
    url(r'^ubuzima/newborn/(?P<indic>\d+)/(?P<format>html|csv)$', views.view_newborn),
   # url(r'^batchimport/', include('batchimport.urls')),

    ##Generic Views
   
    url(r'^ubuzima/reports$', views.ReportListView.as_view()),
)
