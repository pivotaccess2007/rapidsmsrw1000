...
class Location(models.Model):
    ...
    cell = models.ForeignKey("Location", related_name="location_cell", null=True, blank=True,
        help_text="The sector of this Location. Although it is not enforced, it" +\
                  "is expected that the cell will be of a different LocationType")
    sector = models.ForeignKey("Location", related_name="location_sector", null=True, blank=True,
        help_text="The sector of this Location. Although it is not enforced, it" +\
                  "is expected that the sector will be of a different LocationType")
    district = models.ForeignKey("Location", related_name="location_district", null=True, blank=True,
        help_text="The district of this Location. Although it is not enforced, it" +\
                  "is expected that the district will be of a different LocationType")
    province = models.ForeignKey("Location", related_name="location_province", null=True, blank=True,
        help_text="The district of this Location. Although it is not enforced, it" +\
                  "is expected that the province will be of a different LocationType")
    nation = models.ForeignKey("Location", related_name="location_nation", null=True, blank=True,
        help_text="The nation of this Location. Although it is not enforced, it" +\
                  "is expected that the province will be of a different LocationType")
    population = models.DecimalField(max_digits=8, decimal_places=6, blank=True, null=True, help_text="Population")
    women = models.DecimalField(max_digits=8, decimal_places=6, blank=True, null=True, help_text="Number of Women")
