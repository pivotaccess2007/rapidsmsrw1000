...
class Patient(models.Model):
    ...
    cell = models.ForeignKey(Location, related_name = 'patcell', null=True, blank=True)
    sector = models.ForeignKey(Location, related_name = 'patsector', null=True, blank=True)
    district = models.ForeignKey(Location, related_name = 'patdistrict', null=True, blank=True)
    province = models.ForeignKey(Location, related_name = 'patprovince', null=True, blank=True)
    nation = models.ForeignKey(Location, related_name = 'patnation', null=True, blank=True)
...
class Report(models.Model):
    ...
    location = models.ForeignKey(Location)
    village = models.CharField(max_length=255, null=True)
    cell = models.ForeignKey(Location, related_name = 'reportcell', null=True, blank=True)
    sector = models.ForeignKey(Location, related_name = 'reportsector', null=True, blank=True)
    district = models.ForeignKey(Location, related_name = 'reportdistrict', null=True, blank=True)
    province = models.ForeignKey(Location, related_name = 'reportprovince', null=True, blank=True)
    nation = models.ForeignKey(Location, related_name = 'reportnation', null=True, blank=True)
...
class Field(models.Model):
    ...
    village = models.CharField(max_length=255, null=True)
    cell = models.ForeignKey(Location, related_name = 'fieldcell', null=True)
    sector = models.ForeignKey(Location, related_name = 'fieldsector', null=True)
    district = models.ForeignKey(Location, related_name = 'fielddistrict', null=True)
    province = models.ForeignKey(Location, related_name = 'fieldprovince', null=True)
    nation = models.ForeignKey(Location, related_name = 'fieldnation', null=True)
...
class Reminder(models.Model):
    ...
    village = models.CharField(max_length=255, null=True)
    cell = models.ForeignKey(Location, related_name = 'remindercell', null=True)
    sector = models.ForeignKey(Location, related_name = 'remindersector', null=True)
    district = models.ForeignKey(Location, related_name = 'reminderdistrict', null=True)
    province = models.ForeignKey(Location, related_name = 'reminderprovince', null=True)
    nation = models.ForeignKey(Location, related_name = 'remindernation', null=True)
...
class HealthIndicator(models.Model):
    name        = models.CharField(max_length=128)
    description = models.TextField()
    category = models.ForeignKey(IndicatorCategory, related_name = 'indicatorcategory')
...
class LocationShorthand(models.Model):
    ...
    original = models.ForeignKey(Location, related_name = 'shortlocationslocation')
    district = models.ForeignKey(Location, related_name = 'shortdistrict')
    province = models.ForeignKey(Location, related_name = 'shortprovince')
...
class Refusal(models.Model):
    ...
    village = models.CharField(max_length=255, null=True)
    cell = models.ForeignKey(Location, related_name = 'refusalcell', null=True)
    sector = models.ForeignKey(Location, related_name = 'refusalsector', null=True)
    district = models.ForeignKey(Location, related_name = 'refusaldistrict', null=True)
    province = models.ForeignKey(Location, related_name = 'refusalprovince', null=True)
    nation = models.ForeignKey(Location, related_name = 'refusalnation', null=True)
    created = models.DateTimeField(auto_now_add=True)
    def __unicode__(self):
...
class ErrorNote(models.Model):
    ...
    village = models.CharField(max_length=255, null=True)
    cell = models.ForeignKey(Location, related_name = 'errorcell', null=True)
    sector = models.ForeignKey(Location, related_name = 'errorsector', null=True)
    district = models.ForeignKey(Location, related_name = 'errordistrict', null=True)
    province = models.ForeignKey(Location, related_name = 'errorprovince', null=True)
    nation = models.ForeignKey(Location, related_name = 'errornation', null=True)
...
class UserLocation(models.Model):
	...
	location=models.ForeignKey(Location)
	village = models.CharField(max_length=255, null=True)
	cell = models.ForeignKey(Location, related_name = 'usercell', null=True)
	sector = models.ForeignKey(Location, related_name = 'usersector', null=True)
	district = models.ForeignKey(Location, related_name = 'userdistrict', null=True)
	province = models.ForeignKey(Location, related_name = 'userprovince', null=True)
	nation = models.ForeignKey(Location, related_name = 'usernation', null=True)
	def __unicode__(self):
...
class TriggeredAlert(models.Model):
    ...
    village = models.CharField(max_length=255, null=True)
    cell = models.ForeignKey(Location, related_name = 'triggeralertcell', null=True)
    sector = models.ForeignKey(Location, related_name = 'triggeralertsector', null=True)
    district = models.ForeignKey(Location, related_name = 'triggeralertdistrict', null=True)
    province = models.ForeignKey(Location, related_name = 'triggeralertprovince', null=True)
    nation = models.ForeignKey(Location, related_name = 'triggeralertnation', null=True)
...
class Chw(models.Model):
	...
	EDU_CHOICES = ( ('P', 'Primary'), ('S', 'Secondary'), ('U', 'University'), ('N', 'None') )
	ROLE_CHOICES = ( ('CHW', 'ASM'), ('Binome', 'Binome') )
	...
	sex = models.CharField( max_length = 10, blank = False , choices = SEX_CHOICES )
	edu_level = models.CharField( max_length = 10, blank = False, choices = EDU_CHOICES )
	dob = models.DateField(blank=True, null = True)
    	nid = models.CharField(max_length = 16, unique=True)
	phone = models.CharField(max_length = 13 , null = True, blank = True)
	facility = models.ForeignKey(Location, related_name="chw_fosa", null=True, blank=True)
	village    = models.CharField(max_length=255, null=True)
	cell = models.ForeignKey(Location, related_name = 'chw_cell', null=True, blank=True)
	sector = models.ForeignKey(Location, related_name = 'chw_sector', null=True, blank=True)
	district = models.ForeignKey(Location, related_name = 'chw_district', null=True, blank=True)
	province = models.ForeignKey(Location, related_name = 'chw_province', null=True, blank=True)
	nation = models.ForeignKey(Location, related_name = 'chw_nation', null=True, blank=True)

	def __unicode__(self):
		return "%s(%s) : %s"%(self.surname,self.nid,self.phone)
	#def __init__(self):
	#	return self.nid
	### it's better while registering getting province, district then ....up to village. eg:
	#def get_location_name_like(name):
