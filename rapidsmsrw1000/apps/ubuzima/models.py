...
class Departure(models.Model):
    ...
    district = models.ForeignKey(Location, related_name = 'depdistrict', null=True)
    province = models.ForeignKey(Location, related_name = 'depprovince', null=True)
    nation = models.ForeignKey(Location, related_name = 'depnation', null=True)
    created = models.DateTimeField(auto_now_add=True)
