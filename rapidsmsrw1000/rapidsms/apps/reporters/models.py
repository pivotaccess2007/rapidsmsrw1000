...
class Reporter(models.Model):
    ...
    cell = models.ForeignKey(Location, related_name = 'reportercell', null=True, blank=True)
    sector = models.ForeignKey(Location, related_name = 'reportersector', null=True, blank=True)
    district = models.ForeignKey(Location, related_name = 'reporterdistrict', null=True, blank=True)
    province = models.ForeignKey(Location, related_name = 'reporterprovince', null=True, blank=True)
    nation = models.ForeignKey(Location, related_name = 'reporternation', null=True, blank=True)
